...
namespace requests
{
	...
	const req_headers DISCORD = {
	{"Content-Type", "application/json"}, {"User-Agent", "Requests 2.0"}
	};
	...
	request* post(std::string url, const post_data& pdata, req_headers h_data = DISCORD,
		u_short port = 80);
}